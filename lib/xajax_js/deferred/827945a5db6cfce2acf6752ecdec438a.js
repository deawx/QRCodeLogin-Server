...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_editor=function(){return xajax.request({xjxfun:'editor'},{parameters:arguments});};xajax_submit=function(){return xajax.request({xjxfun:'submit'},{parameters:arguments});};xajax_load=function(){return xajax.request({xjxfun:'load'},{parameters:arguments});};