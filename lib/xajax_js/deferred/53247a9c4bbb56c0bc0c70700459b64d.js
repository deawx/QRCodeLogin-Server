...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_send=function(){return xajax.request({xjxfun:'send'},{parameters:arguments});};xajax_read=function(){return xajax.request({xjxfun:'read'},{parameters:arguments});};xajax_bye=function(){return xajax.request({xjxfun:'bye'},{parameters:arguments});};